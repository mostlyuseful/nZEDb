...
<head>
	...
	<link href="{$smarty.const.WWW_THEMES}/shared/libs/bootstrap/docs/assets/css/bootstrap.css" rel="stylesheet"
		  type="text/css"/>
...
<div id="page">
	...
	<script src="{$smarty.const.WWW_THEMES}/shared/libs/bootstrap/docs/assets/js/bootstrap.min.js"></script>
